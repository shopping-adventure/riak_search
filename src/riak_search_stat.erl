...
update1(P, Arg) ->
    case riak_core_stat:stat_system() of
        ...
        exometer -> update1_exometer(P, Arg)
    end.
update1_legacy(index_begin) ->
    folsom_metrics:notify_existing_metric({?APP, index_pending}, {inc, 1}, counter);
update1_legacy({index_end, Time}) ->
